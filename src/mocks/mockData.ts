    ...
    journeyPatterns: [
      {
        ...
        description: 'Hovedrute via Stortinget',
        privateCode: 'JP3',
        pointsInSequence: [
          {
        ...
        serviceJourneys: [
          {
            ...
            name: 'Morgenrute',
            description: 'Morgenavgang Majorstuen - Tøyen',
            privateCode: 'SJ4',
            publicCode: '201-1',
            operatorRef: 'TST:Operator:1',
            notices: [],
          ...
          {
            id: 'TST:ServiceJourney:6',
            name: 'Formiddagsrute',
            description: 'Formiddagsavgang Majorstuen - Tøyen',
            privateCode: 'SJ6',
            publicCode: '201-2',
            operatorRef: 'TST:Operator:1',
            notices: [{ text: 'Kun hverdager' }],
            passingTimes: [
              {
                id: 'TST:TimetabledPassingTime:12',
                arrivalTime: null,
                arrivalDayOffset: 0,
              ...
              {
                id: 'TST:TimetabledPassingTime:13',
                arrivalTime: '09:40:00',
                arrivalDayOffset: 0,
                departureTime: '09:41:00',
                departureDayOffset: 0,
                latestArrivalTime: null,
                latestArrivalDayOffset: 0,
                earliestDepartureTime: null,
              ...
              {
                id: 'TST:TimetabledPassingTime:14',
          ...
          {
            id: 'TST:ServiceJourney:7',
            name: 'Ettermiddagsrute',
            description: 'Ettermiddagsavgang Majorstuen - Tøyen',
            privateCode: 'SJ7',
            publicCode: '201-3',
            operatorRef: 'TST:Operator:1',
            notices: [],
            passingTimes: [
              {
                id: 'TST:TimetabledPassingTime:15',
                arrivalTime: null,
                arrivalDayOffset: 0,
              ...
              {
                id: 'TST:TimetabledPassingTime:16',
                arrivalTime: '15:40:00',
                arrivalDayOffset: 0,
                departureTime: '15:41:00',
                departureDayOffset: 0,
                latestArrivalTime: null,
                latestArrivalDayOffset: 0,
                earliestDepartureTime: null,
              ...
              {
                id: 'TST:TimetabledPassingTime:17',
            ...
            dayTypes: [mockDayTypes[0], mockDayTypes[1]],
          },
        ],
      },
      {
        id: 'TST:JourneyPattern:5',
        name: 'Tøyen - Majorstuen via Stortinget',
        description: 'Returretning via Stortinget',
        privateCode: 'JP5',
        pointsInSequence: [
          {
            id: 'TST:StopPointInJourneyPattern:10',
            flexibleStopPlace: null,
            quayRef: 'NSR:Quay:2003',
          ...
          {
            id: 'TST:StopPointInJourneyPattern:11',
            flexibleStopPlace: null,
            quayRef: 'NSR:Quay:2002',
            destinationDisplay: { frontText: 'Majorstuen' },
            forBoarding: true,
          ...
          {
            id: 'TST:StopPointInJourneyPattern:12',
            flexibleStopPlace: null,
            quayRef: 'NSR:Quay:2001',
            destinationDisplay: null,
            forBoarding: false,
        ...
        serviceJourneys: [
          {
            id: 'TST:ServiceJourney:8',
            name: 'Morgenretur',
            description: 'Morgenavgang Tøyen - Majorstuen',
            privateCode: 'SJ8',
            publicCode: '201-R1',
            operatorRef: 'TST:Operator:1',
            notices: [],
            passingTimes: [
              {
                id: 'TST:TimetabledPassingTime:18',
                arrivalTime: null,
                arrivalDayOffset: 0,
                departureTime: '08:00:00',
                departureDayOffset: 0,
              ...
              {
                id: 'TST:TimetabledPassingTime:19',
              ...
              {
                id: 'TST:TimetabledPassingTime:20',
          ...
          {
            id: 'TST:ServiceJourney:9',
            name: 'Ettermiddagsretur',
            description: 'Ettermiddagsavgang Tøyen - Majorstuen',
            privateCode: 'SJ9',
            publicCode: '201-R2',
            operatorRef: 'TST:Operator:1',
            notices: [],
            passingTimes: [
              {
                id: 'TST:TimetabledPassingTime:21',
                arrivalTime: null,
                arrivalDayOffset: 0,
              ...
              {
                id: 'TST:TimetabledPassingTime:22',
                arrivalTime: '16:27:00',
                arrivalDayOffset: 0,
                departureTime: '16:28:00',
                departureDayOffset: 0,
                latestArrivalTime: null,
                latestArrivalDayOffset: 0,
                earliestDepartureTime: null,
              ...
              {
                id: 'TST:TimetabledPassingTime:23',
        ...
        serviceJourneys: [
          {
            ...
            name: 'Ekspressavgang morgen',
            description: 'Morgenekspressen',
            privateCode: 'SJ5',
            publicCode: '202-1',
            operatorRef: 'TST:Operator:1',
            notices: [],
          ...
          {
            id: 'TST:ServiceJourney:10',
            name: 'Ekspressavgang ettermiddag',
            description: 'Ettermiddagekspressen',
            privateCode: 'SJ10',
            publicCode: '202-2',
            operatorRef: 'TST:Operator:1',
            notices: [{ text: 'Ekstra stopp ved Skøyen på fredager' }],
            passingTimes: [
              {
                id: 'TST:TimetabledPassingTime:24',
                arrivalTime: null,
                arrivalDayOffset: 0,
              ...
              {
                id: 'TST:TimetabledPassingTime:25',
