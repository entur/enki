...
export const messages = {
  ...
  generalPrivateCodeFormGroupTitle: 'Yksityinen koodi',
  generalPrivateCodeInputLabelTooltip:
    'Yksityinen koodi on se, mikä tunnistaa linjan sisäisesti operaattorille',
  generalPublicCodeFormGroupTitle: 'Julkinen koodi *',
  generalPublicCodeInputLabelTooltip:
    'Julkinen koodi on se, mikä tunnistaa linjan ulkoisesti matkustajille',
  ...
  flexibleLineTypeDrawer_fixed:
    'Kiinteä reitti kiinteisiin aikoihin, on varattava etukäteen bussin ajoa varten.',
  ...
  stepperServiceJourney: 'Palvelun lähtö',
  ...
  selectNsr: 'Pysäkki',
  editorServiceJourneys: 'Palvelun lähtö',
  ...
  generalPrivateCodeLabel: 'Yksityinen koodi',
  generalPrivateCodeLabelTooltip:
    'Yksityinen koodi on se, mikä tunnistaa pysäkkiketjun sisäisesti operaattorille',
  ...
  editorSaveAndCreateLine: 'Tallenna ja luo viiva',
  ...
  labelForAlighting: 'Laskeutumista varten',
  ...
  frontTextBoarding: 'Viimeinen pysäkki voi olla vain laskeutumista varten',
  ...
  generalPrivateCode: 'Yksityinen koodi',
  generalPrivateCodeTooltip:
    'Yksityinen koodi on se, mikä tunnistaa palvelumatkan sisäisesti operaattorille',
  generalPublicCode: 'Julkinen koodi',
  generalPublicCodeTooltip:
    'Julkinen koodi on se, mikä tunnistaa palvelumatkan ulkoisesti matkustajille',
  ...
  linesPublicCodeTableHeaderLabel: 'Julkinen koodi',
  linesPrivateCodeTableHeaderLabel: 'Yksityinen koodi',
  nameEmpty: 'Nimi vaaditaan.',
  publicCodeEmpty: 'Julkinen koodi vaaditaan.',
  ...
  editorNetworkPrivateCodeLabelText: 'Yksityinen koodi',
  ...
  networksPrivateCodeTableHeaderLabel: 'Yksityinen koodi',
  ...
  editorPrivateCodeFormLabelText: 'Yksityinen koodi',
  ...
  stopPlacesPrivateCodeTableHeaderLabelText: 'Yksityinen koodi',
  ...
  airportLinkBus: 'Lentokenttäyhteysbussi',
  expressBus: 'Pikavuoro',
  localBus: 'Paikallisbussi',
  nightBus: 'Yöbussi',
  railReplacementBus: 'Junaa korvaava bussi',
  regionalBus: 'Alueellinen bussi',
  schoolBus: 'Koulubussi',
  shuttleBus: 'Pendelöintibussi',
  ...
  providersCodeTableHeaderLabel: 'Koodi',
  ...
  editorProviderCodeLabelText: 'Koodi *',
